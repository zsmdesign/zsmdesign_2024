...
export default function FrontEnd () {
   ...
   const contentArray = [
      {id: 1, title: 'Silent Push', link: 'https://www.silentpush.com/', pGraphOne: <p>Being part of the U.S.-based startup, SilentPush, has been a genuine privilege, affording me the opportunity to interact with some of the most brilliant and experienced minds in the realms of cybersecurity and threat intelligence. The flagship software, which I have the honor of contributing to, diligently maps the entirety of the internet daily, proactively notifying users of any relevant alterations to their assets as well as any potential rogue threats. </p>, pGraphTwo: <p>By harnessing the combined prowess of React, Redux, and cutting-edge websocket technology, we ensure that ever-evolving data is seamlessly delivered to the user. I take pride in having extensively revamped the user interface on SilentPush's flagship app, aligning it more closely with contemporary standards.</p>},
      ...
      {id: 5, title: 'Freshconstruct', link: 'https://freshconstruct.com/', pGraphOne: <p>This versatile agency boasts a team of seasoned professionals dedicated to a broad spectrum of tasks. We leverage the latest front-end technologies in the industry, including Angular, Next.js, and React, making it essential for our team to be comprised of top-tier. This type of work requires the agility to handle rapidly shifting requirements.</p>, pGraphTwo: <p>I actively contributed to the development of a live event spectator aggregation software known as "ThatsTheTicket," which made its debut in Australia. This innovative tool excels in crowd organization, streamlining ticket distribution, and providing invaluable event statistics. Additionally, I had a chance to work with McArthurGlen on a different project, contributing to their continued success.</p>},
   ];
         ...
         <div className={styles.sitesContainer} ref={targetRef}>
            ...
            <div className={cn(styles.pictureColumn, {[styles.loaded]: cardsLoaded})}>
               <div className={styles.animator}>
                  <div id="silentCard" className={styles.picture} onClick={() => handleCardClick(1)} style={{background: `url('/images/cards/${(silentCardZoom === 180 || currentCardId === 1) ? 'silent-color' : 'silent-faded'}.jpg') center center / ${currentCardId === 1 ? 170 : silentCardZoom}% no-repeat`}}></div>
               </div>
               <div className={styles.animator}>
               ...
               <div className={styles.animator}>
                  <div id="oracleCard" className={styles.picture} onClick={() => handleCardClick(3)} style={{background: `url('/images/cards/${(oracleCardZoom === 180 || currentCardId === 3) ? 'oracle-color' : 'oracle-faded'}.jpg') center center / ${currentCardId === 3 ? 170 : oracleCardZoom}% no-repeat`}}></div>
               </div>
               <div className={styles.animator}>
